...
void PrintWelcomeInfo()
{
    cout << "The program lists a product with price between " 
         << lowest_price << " and " << highest_price << " RMB.\n";
...
double PlayGame()
{
    ...
    while(true)
    {
        ...
        if(PlayBout(actual_price, lower_price, highest_price, chances_left))
...
static int CheckPrice(int lower_price, int higher_price, int guess_price)
{
    ...
    {
        cout << "Guess price " << t << " is out of range.";
